...
本リポジトリでは、Project PLATEAUの令和6年度「都市デジタルツインの実現に向けた研究開発及び実証調査業務」（内閣府/研究開発とSociety5.0との橋渡しプログラム（BRIDGE））におけるuc23-24「3D都市モデルを活用した建物振動シミュレーションシステムの開発」（建物振動に関する大規模シミュレーション）において開発した「建物振動シミュレーションシステム」のソースコードを公開しています。
